...
const FavIcon = ({ displayAlert, selected, numFavourites }) => {
  return (
    <svg width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        !!numFavourites && numFavourites > 0 && (
          <text x="11" y="10" fill="black" fontSize="11" textAnchor="middle" dominantBaseline="middle">{numFavourites}</text>
        )
      }
    </svg>
  );
